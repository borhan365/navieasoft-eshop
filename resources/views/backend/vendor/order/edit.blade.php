        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('vendor/update-shipping-address', [$order->id])}}" method="post">
              	@csrf
                <div class="card-body">
                  <div class="form-group">
                    <label>Address</label>
          ...
          <div class="col-md-3">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('vendor/update-order-summery', [$order->id])}}" method="post">
              	@csrf
                <div class="card-body">
                  <div class="form-group">
