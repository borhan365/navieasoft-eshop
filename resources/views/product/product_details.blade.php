                            ...
                            <div class="row align-items-center">
                                <div class="sold-by col-auto">
                                    <small class="mr-2">Sold by: </small><br>
                                        ...
                                        <a href="#">{{$shop->name ?? 'Admin Product'}}</a>
...
<!--                                                 <span class="input-group-btn">
                                                ...
                                                <select name="attribute_value" id="attribute_value" class="form-control fz-small h-auto" onchange="AttributValue()" required="">
...
<!--                                                 <p style="width: 150px;">{{ $product_attribute->product_attribute_attribute_value->attribute_value->value ?? ''}}</p>
 ...
 -->
                                                ...
                                                <input type="text" name="quantity" class="form-control fz-small h-auto w-100 input-number text-center mx-4" placeholder="1" value="1" id="quantity" onkeyup="TotalAmountHandaler()">
                                               

                                                <button class="btn btn-number bg-white border" type="button" data-type="plus" data-field="quantity" onclick="IncreseValue()">
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    <!-- Buy Now button -->
                                        ...
                                        <button type="submit" class="btn btn-danger btn-styled btn-base-1 btn-icon-left strong-700 hov-bounce hov-shaddow buy-now fz-small">
                            			...
                            			<form action="{{route('add-to-cart')}}" method="post">
                                        	...
                                        	<button type="submit" class="btn btn-success btn-styled fz-small btn-alt-base-1 c-white btn-icon-left strong-700 hov-bounce hov-shaddow ml-2 add-to-cart">
    ...
    <section class="gry-bg">
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="seller-info-box mb-3">
                        <div class="sold-by position-relative">
                            ...
                            <div class="title">Sold By</div>
                                ...
                                <a href="#" class="name d-block">{{$shop->name ?? 'Admin Product'}}
                                    <span class="ml-2"><i class="fa fa-check-circle" style="color:green"></i></span>
                                    <span class="ml-2"><i class="fa fa-times-circle" style="color:red"></i></span>
                                    <i class="icofont-check-circled mr-2 text-success"></i>
                                    <i class="icofont-close-circled text-danger"></i>
                                </a>
                                <div class="location">{{$shop->address ?? 'Dhaka, Bangladesh'}}</div>
                        ...
                        <div class="row no-gutters align-items-center">
                                ...
                                <div class="col">
                                	<div>
                                		<a href="#"><i class="fz-normal icofont-facebook"></i></a>
                                		<a href="#"><i class="fz-normal icofont-twitter"></i></a>
                                	</div>
                                </div>
                ...
                <div class="col-xl-9">
                    <div class="product-desc-tab bg-white p-3">
                        <div class="tabs tabs--style-2">
                            <ul class="nav nav-tabs justify-content-center sticky-top bg-white mb-4">
                                <li class="nav-item">
                                    <a href="#tab_default_1" data-toggle="tab" class="nav-link text-uppercase strong-600 ">Description</a>
                                </li>

                                <li class="nav-item">
                                    <a href="#tab_default_4" data-toggle="tab" class="nav-link text-uppercase strong-600 active show">Reviews</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content pt-0">
                                <div class="tab-pane " id="tab_default_1">
                                    <div class="row">
                                        <div class="col-md-12">
                                           <!-- {!!$product->description!!} -->
                                           Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam expedita odit magni minima fugiat! Doloribus, error ducimus corporis necessitatibus eaque distinctio fugit dolorem at vitae officiis repellat tempore vero quia laudantium vel praesentium aliquid atque. Repellendus, nesciunt. Sit ex, veniam culpa cum animi voluptas esse voluptate similique rerum itaque neque magnam sint ut, impedit sequi. Consequuntur vel sapiente dolore sed perspiciatis porro accusamus quam laudantium eius quibusdam ducimus minus rerum nulla illo incidunt molestiae laboriosam, velit corrupti error blanditiis, autem? Illo error, fugiat enim, doloribus, dolores dolor saepe aspernatur reiciendis dolorem laborum quos magnam incidunt blanditiis mollitia, voluptatum provident iure.
                                ...
                                <div class="tab-pane active show" id="tab_default_4">
                                    <div class="fluid-paragraph py-4 mx-auto" style="max-width: 50rem">
                                            ...
                                            <div class="block block-comment">
                                                ...
                                                <div class="block-body">
                                                    <div class="block-body-inner">
                                                        <div class="row ">
                                                        	<div class="col-auto">
                                                        		<img src="{{asset('public/frontend/img/logo.png')}}" data-src="images/placeholder.jpg" class="rounded-circle lazyload" style="height: 6rem;width: 6rem;">
                                                        	</div>
                                                            <div class="col">
                                                                <h3 class="heading heading-6">
                                                                    <a href="javascript:void(0);">Karim</a>
                                                                </h3>
                                                ...
                                                <div class="leave-review mt-5">
                                                    <div class="section-title section-title--style-1">
                                                        <h4 class="section-title-inner heading-6 strong-600 text-uppercase mb-4">
                                                            Write a review
                                                        </h4>
                                                    </div>
                                                    <form class="form-default" role="form" action="#" method="POST">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="name" value="" class="form-control fz-normal h-auto"  required>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="" class="text-uppercase c-gray-light">Email</label>
                                                                    <input type="text" name="email" value="" class="form-control fz-normal h-auto" required >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-sm-12">
                                                                <textarea class="form-control fz-normal" rows="4" name="comment" placeholder="Your review" required></textarea>
                                                            </div>
                                                        </div>

                                                        <div class="text-right">
                                                            <button type="submit" class="btn btn-styled btn-base-1 btn-circle mt-4 btn-info fz-normal">
                                                                Send review
                                                            </button>
                                                        </div>
                                                    </form>
