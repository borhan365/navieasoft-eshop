      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{URL::to('vendor/dashboard')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="{{URL::to('vendor/order')}}" class="nav-link">
          ...
          <li class="nav-item has-treeview
          {{ request()->is('vendor/withdraw') ? 'menu-open' : '' }}
          ">
            <a href="{{URL::to('vendor/withdraw')}}" class="nav-link">
              <i class="nav-icon fas fa-dollar-sign"></i>
              <p>
                Withdraw
              </p>
          ...
          <li class="nav-item has-treeview  
              {{ request()->is('vendor/product/create') ? 'menu-open' : '' }}
              {{ request()->is('vendor/product') ? 'menu-open' : '' }}
          ">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item {{ request()->is('vendor/product/create') ? 'active' : '' }}">
                <a href="{{URL::to('vendor/product/create')}}" class="nav-link {{ request()->is('vendor/product/create') ? 'active' : '' }}">
              ...
              <li class="nav-item {{ request()->is('vendor/product') ? 'active' : '' }}">
                <a href="{{URL::to('vendor/product')}}" class="nav-link {{ request()->is('vendor/product') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Product</p>
                </a>
              </li>
