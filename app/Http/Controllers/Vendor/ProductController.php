...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.vendor.product.create', compact('brands', 'categories', 'colors', 'sizes', 'attributes', 'user_id', 'user_type'));
    }
    ...
    public function store(Request $request)
    {
        $product = new Product();
        $product->admin_id = 1;
        $product->vendor_id = $request->user_id;
    ...
    public function edit($id)
    {
        ...
        return view('backend.vendor.product.edit', compact('product', 'brands', 'categories', 'colors', 'sizes', 'product_sizes', 'product_colors', 'productImages', 'product_categories', 'product_attributes', 'ProductVariations', 'attributes'));
    }
    ...
    public function get_attribute_value(Request $request){
        ...
        return view('backend.vendor.attribute.get_attribute_value',compact('attribute_values'));
    }
